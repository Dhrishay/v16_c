...
class AccountMoveLine(models.Model):
    ...
    def _get_price_total_and_subtotal_model(self, price_unit, quantity, discount, currency, product, partner, taxes, move_type):
        print("\n\n\n_get_price_total_and_subtotal_model---------------------accountmove--move line-----------------------------------")
...
class AccountMove(models.Model):
    ...
    def _get_mail_template(self):
        print("\n\n\n_get_mail_template-------------------------accountmove-----------1st-------------------")
        return (
            'custom_attribute_placeholder_cr.email_template_edi_invoice'
    ...
    def _compute_amount(self):
        print("\n\n\n_compute_amount------------------------------1st---accountmove-------------------------------------")
    ...
    def _compute_tax_totals_json(self):
        print("\n\n\n_compute_tax_totals_json-----------------accountmove---------------------------------")
    ...
    def _get_reconciled_invoices_partials(self):
        print("\n\n\n_get_reconciled_invoices_partials-------------------accountmove----------------------------------")
    ...
    def _compute_custom_tax(self):
        print("\n\n\n_compute_custom_tax----------------------accountmove--------------------------")
    ...
    def _recompute_tax_lines(self, recompute_tax_base_amount=False, tax_rep_lines_to_recompute=None):
        print("\n\n\n_recompute_tax_lines--------------------accountmove--------------2----------------------")
        ...
        def _serialize_tax_grouping_key(grouping_dict):
            print("\n\n\n_serialize_tax_grouping_key-----------------accountmove------------------------------")
        ...
        def _compute_base_line_taxes(base_line):
            print("\n\n\n_compute_base_line_taxes-----------------accountmove--------------------------------")
