...
class PosConfig(models.Model):
    ...
    def get_products_loading_in_background(self, fields, offset, limit):
        print("\n\n\nget_products_loading_in_background--------------------------------------------")
