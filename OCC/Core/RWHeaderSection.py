...
import odoo.addons.OCC.Core.HeaderSection
...
class RWHeaderSection_GeneralModule(odoo.addons.OCC.Core.StepData.StepData_GeneralModule):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
...
class RWHeaderSection_ReadWriteModule(odoo.addons.OCC.Core.StepData.StepData_ReadWriteModule):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
