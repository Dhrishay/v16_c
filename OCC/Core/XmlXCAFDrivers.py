...
import odoo.addons.OCC.Core.XmlDrivers
...
class XmlXCAFDrivers_DocumentRetrievalDriver(odoo.addons.OCC.Core.XmlDrivers.XmlDrivers_DocumentRetrievalDriver):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
...
class XmlXCAFDrivers_DocumentStorageDriver(odoo.addons.OCC.Core.XmlDrivers.XmlDrivers_DocumentStorageDriver):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
