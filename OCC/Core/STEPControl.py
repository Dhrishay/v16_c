...
def _dumps_object(klass):
    ...
    <odoo.addons.OCC.Core.TopoDS.TopoDS_Shape; proxy of <Swig Object of type 'TopoDS_Shape *' at 0x02BB0758> >
...
# for TopoDS_Shape, we also look for the base type
    if klass_name == "TopoDS_Shape":
        if klass.IsNull():
            ...
            return repr_string
        st = klass.ShapeType()
        types = {odoo.addons.OCC.Core.TopAbs.TopAbs_VERTEX: "Vertex",
                 odoo.addons.OCC.Core.TopAbs.TopAbs_SOLID: "Solid",
                 odoo.addons.OCC.Core.TopAbs.TopAbs_EDGE: "Edge",
                 odoo.addons.OCC.Core.TopAbs.TopAbs_FACE: "Face",
                 odoo.addons.OCC.Core.TopAbs.TopAbs_SHELL: "Shell",
                 odoo.addons.OCC.Core.TopAbs.TopAbs_WIRE: "Wire",
                 odoo.addons.OCC.Core.TopAbs.TopAbs_COMPOUND: "Compound",
                 odoo.addons.OCC.Core.TopAbs.TopAbs_COMPSOLID: "Compsolid"}
...
class STEPControl_ActorRead(odoo.addons.OCC.Core.Transfer.Transfer_ActorOfTransientProcess):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
...
class STEPControl_ActorWrite(odoo.addons.OCC.Core.Transfer.Transfer_ActorOfFinderProcess):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
...
class STEPControl_Controller(odoo.addons.OCC.Core.XSControl.XSControl_Controller):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
...
class STEPControl_Reader(odoo.addons.OCC.Core.XSControl.XSControl_Reader):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
