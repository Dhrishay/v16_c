...
import odoo.addons.OCC.Core.ChFi2d
import odoo.addons.OCC.Core.TopOpeBRepBuild
import odoo.addons.OCC.Core.TopOpeBRepDS
...
import odoo.addons.OCC.Core.ChFi3d
import odoo.addons.OCC.Core.BRepBlend
...
class BRepFilletAPI_LocalOperation(odoo.addons.OCC.Core.BRepBuilderAPI.BRepBuilderAPI_MakeShape):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
...
class BRepFilletAPI_MakeFillet2d(odoo.addons.OCC.Core.BRepBuilderAPI.BRepBuilderAPI_MakeShape):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
