...
class XmlObjMgt_RRelocationTable(odoo.addons.OCC.Core.TColStd.TColStd_DataMapOfIntegerTransient):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
...
class XmlObjMgt_SRelocationTable(odoo.addons.OCC.Core.TColStd.TColStd_IndexedMapOfTransient):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
