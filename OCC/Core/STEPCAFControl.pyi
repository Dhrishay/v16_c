...
class STEPCAFControl_Reader:
    ...
    @overload
    def Perform(self, filename: str, doc: TDocStd_Document, theParams: StepData_ConfParameters, theProgress: Optional[Message_ProgressRange] = Message_ProgressRange()) -> bool: ...
    @overload
    def Perform(self, filename: str, doc: TDocStd_Document, theProgress: Optional[Message_ProgressRange] = Message_ProgressRange()) -> bool: ...
    @overload
    def Perform(self, filename: str, doc: TDocStd_Document, theParams: StepData_ConfParameters, theProgress: Optional[Message_ProgressRange] = Message_ProgressRange()) -> bool: ...
    ...
    @overload
    def ReadFile(self, theFileName: str, theParams: StepData_ConfParameters) -> IFSelect_ReturnStatus: ...
...
class STEPCAFControl_Writer:
    ...
    def Perform(self, theDoc: TDocStd_Document, theFileName: str, theProgress: Optional[Message_ProgressRange] = Message_ProgressRange()) -> bool: ...
    @overload
    def Perform(self, theDoc: TDocStd_Document, theFileName: str, theParams: StepData_ConfParameters, theProgress: Optional[Message_ProgressRange] = Message_ProgressRange()) -> bool: ...
    ...
    @overload
    def Transfer(self, theDoc: TDocStd_Document, theParams: StepData_ConfParameters, theMode: Optional[STEPControl_StepModelType] = STEPControl_AsIs, theIsMulti: Optional[str] = 0, theProgress: Optional[Message_ProgressRange] = Message_ProgressRange()) -> bool: ...
    @overload
    ...
    @overload
    def Transfer(self, theLabel: TDF_Label, theParams: StepData_ConfParameters, theMode: Optional[STEPControl_StepModelType] = STEPControl_AsIs, theIsMulti: Optional[str] = 0, theProgress: Optional[Message_ProgressRange] = Message_ProgressRange()) -> bool: ...
    @overload
    ...
    @overload
    def Transfer(self, theLabelSeq: TDF_LabelSequence, theParams: StepData_ConfParameters, theMode: Optional[STEPControl_StepModelType] = STEPControl_AsIs, theIsMulti: Optional[str] = 0, theProgress: Optional[Message_ProgressRange] = Message_ProgressRange()) -> bool: ...
